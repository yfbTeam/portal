<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YQSYLogin.aspx.cs" Inherits="PMSWeb.YQSY.YQSYLogin" %>
...
.Login .login_con form span.btn  input.btn_btn{background:url(/Admin/AdminImg/login.png) no-repeat;width:361px; height:64px; cursor:pointer; border:0; background-size:cover;}
    ...
    <script type="text/javascript">
        ...
        function OnSuccessLogin(json) {
            ...
            if (cookie.errNum == "0") {
                ...
                //document.location.href = "/Admin/index.aspx";
