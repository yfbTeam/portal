<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BeforeView.aspx.cs" Inherits="PMSWeb.YQSY.SitePages.BeforeView" %>
...
<head runat="server">
    ...
    <link href="/YQSY/css/layout.css" rel="stylesheet" id="mystylesheet" />
                                    ...
                                    if (item.FileName != null && item.FileName != "" && item.FileName.length > 0) {
                                        ...
                                        if (item.FilePath != null && item.FilePath!='') {
                                            if(item.FilePath!=null&&item.FilePath!=""){
                                                ...
                                                $("#filePath").html("<a href=\"" + item.FilePath.replace(",", "") + "\" download=\"" + item.FileName.replace(",", "") + "\" style='color:#008412'>" + item.FileName.replace(",", "") + "</a>");
                                            }
