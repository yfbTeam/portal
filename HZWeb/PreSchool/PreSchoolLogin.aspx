<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreSchoolLogin.aspx.cs" Inherits="PMSWeb.PreSchool.PreSchoolLogin" %>
...
.Login .login_con form span.btn  input.btn_btn{background:url(/Admin/AdminImg/login.png) no-repeat;width:361px; height:64px; cursor:pointer; border:0; outline:none;background-size:cover;}
