<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BeforeItemList.aspx.cs" Inherits="PMSWeb.DYYX.SitePages.BeforeItemList" %>
...
<head runat="server">
    ...
    <script id="item_data" type="text/x-jquery-tmpl">
        <li>
            ...
            <%} %>
            <span class="text"><a href="/DYYX/SitePages/BeforeView.aspx?id=${MenuId}&advId=${Id}" target="_blank">${Description}</a></span>
            <span class="date">
